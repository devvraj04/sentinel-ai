 ...
 * ALL hooks called before any early return — fixes React hooks violation.
 */
...
export const CreditOfficerDashboard: React.FC = () => {
  ...
  useEffect(() => { setPage(0); }, [search, filterTier]);
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={barData}>
                ...
                <Bar dataKey="score" radius={[4, 4, 0, 0]}>
                  {barData.map((_, i) => <Cell key={i} fill={barData[i].fill} />)}
                </Bar>
              </BarChart>
            </ResponsiveContainer>
          </div>
